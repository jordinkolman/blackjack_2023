...
def print_ui(players, dealer, current_player=None):
    ...
    if current_player:
        ...
        print(
            f"Your Hand: {current_player.show_hand()}  Your Score: {current_player.score}\n\n"
        )
...
def main():
    ...
    print("Blackjack ♠ ♥ ♣ ♦ \n\n")
    print(
        "Hello! Welcome to BlackJack. The game is get as close to 21 without going over."
    )
    print()
    ...
    while play_again != "n":
        ...
        if dealer in winners:
            ...
            print(
                f"Congratulations! The following players beat the dealer: {[winner.name for winner in winners]}\n"
            )
